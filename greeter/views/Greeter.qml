...
Item {
    ...
    Connections {
        ...
        function onReadyToLaunch() {
            stage = "launching"
            // Launch immediately without timer delay
            Greetd.launch(
        ...
        function onLaunched() {
            // Immediately quit quickshell to allow greeter-Hyprland to exit and hand over VT1
            Qt.quit()
        }
    ...
    SequentialAnimation {
        ...
        ScriptAction {
            script: {
                Greetd.createSession(confirmedUsername)
                stage = "password"
